...
.then(y=>{
  ...
  //  const sortData = [].concat(value).sort((a,b)=>{return a.title - b.title});
      setLoad(!load);
      load ? 
    setData([...value].sort(function compare(a, b) {
      if (a.title < b.title) {
          return -1;
      }
      else{
        ...
        value.map((element) => {
          ...
          return (
              ...
              <div className="card col-6 my-3"  >
                  <img src={element.image} alt="" className="img-thumbnail" style={{maxHeight: "20rem" }}  />
                <div className="card-body">
                  ...
                  <ReactStars count={5} value={element.rating.rate}   isHalf={true}  activeColor={"#ffd700"} size={28} edit={false}/>
