        ...
        {({ values, setValues, errors, touched }) => (
          ...
          <Form className='needs-validation'>
            ...
            <div>
              ...
              <Field type="text" name="firstName" className={'form-control' + (firstNameErrors.name && firstNameTouched.name ? ' is-invalid' : '')}></Field>
                        ...
                        <div key={index}>
                          <div>
                            ...
                            {errors.addField && touched.addField ? (
                              <div className="text-danger">{errors.addField}</div>
                            ) : null}</div>
                          {index > 0 && (
