    ...
    const onHandleChanged = (e) => {
        ...
        if (name === "hobbies") {
            ...
            if (checked) {
                ...
                obj = {
                    ...signform, [name]: signform[name].filter(x => x !== value)
                }
            }
        }
        ...
        switch (name) {
            ...
            case "zipcode":
                if (!value) errMsg = " please enter your zipcode";
                    ...
                    !/([0-9]{6}|[0-9]{3}\s[0-9]{3})/.test(value)
                )
            ...
            case "mobile":
                if (!value) errMsg = "please enter your mobile Number";
                    ...
                    !/^((0091)|(\+91)|0?)[789]{1}\d{9}$/.test(value)
                )
            ...
            case "gender":
                ...
                break;
            case "acceptTerms":
                if (!value) errMsg = "Please select accept the our Terms and Conditiions";
                break;
                ...
                <form>
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="text" className="form-control" placeholder='firstName' name='firstName' value={data.signform.firstName} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="text" className="form-control" placeholder='lastName' name='lastName' value={data.signform.lastName} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="email" className="form-control" placeholder='email' name='email' value={data.signform.email} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="password" className="form-control" placeholder='password' name='password' value={data.signform.password} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="password" className="form-control" placeholder='confirmpassword' name='confirmPassword' value={data.signform.confirmPassword} />
                            {data.signformErrors.confirmPassword && (
                                <span className="err">{data.signformErrors.confirmPassword}</span>
                            )}
                        </div>
                        <div className="form-group col-md-6">
                            <label htmlFor="city">City:</label>
                            <input onChange={onHandleChanged} type="text" className="form-control" name='city' placeholder='city' value={data.signform.city} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="text" className="form-control" name='state' placeholder='state' value={data.signform.state} />
                        ...
                        <div className="form-group col-md-3">
                            ...
                            <input onChange={onHandleChanged} type="text" className="form-control" placeholder='zipcode' name='zipcode' value={data.signform.zipcode} />
                        ...
                        <div className="form-group col-md-3">
                            ...
                            <input onChange={onHandleChanged} type="text" className="form-control" placeholder='mobile' name='mobile' value={data.signform.mobile} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <input onChange={onHandleChanged} type="text" className="form-control" placeholder="1234 Main St" name='address' value={data.signform.address} />
                        ...
                        <div className="form-group col-md-6">
                            ...
                            <ReactSelect
                                name="country"
                                options={countryArr}
                                value={countryArr.find(x => x.value === data.signform.country)}
                                onChange={e =>
                                    onHandleChanged({
                                        target: {
                                            name: "country",
                        ...
                        <div className='col-md-6 my-2'>
                            <label htmlFor="hobbies" className='mr-2'>Hobbies:</label>
                            <div className="form-check form-check-inline">
                                {hobbiesArr.map((x, i) => {
                                    return (
                                        <>
                                            <input onChange={onHandleChanged} className="form-check-input mx-2" type="checkbox" value={x.value} name="hobbies" />{" "}
                                            <label key={i} className="form-check-label" htmlFor="inlineCheckbox1">{x.label}</label>
                                        </>
                                    )
                                })}
                        ...
                        <div className='col-md-6 my-2'>
                            ...
                            <div className="form-check form-check-inline">
                                <input onChange={onHandleChanged} className="form-check-input" type="radio" value="male" name="gender" checked={data.signform.gender === "male"} />
                                <label className="form-check-label" htmlFor="inlineRadio1">Male</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input onChange={onHandleChanged} className="form-check-input" type="radio" name="gender" value="female" checked={data.signform.gender === "female"} />
                                <label className="form-check-label" htmlFor="inlineRadio2">Female</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input onChange={onHandleChanged} className="form-check-input" type="radio" name="gender" value="transgender" checked={data.signform.gender === "transgender"} />
                                <label className="form-check-label" htmlFor="inlineRadio2">transgender</label>
                            </div>
                        ...
                        <div className="form-check ml-2 my-2">
                            <input className="form-check-input" type="checkbox" name='acceptTerms' onChange={onHandleChanged} />
                    ...
                    <div className="col-md-12 text-center my-3">
                        <button type="button" onClick={handlesubmit} value="Submit" className="btn btn-primary mx-2">Submit</button>
